const data = {
  title: "Search movies",
  selector: ["IMDB is higher than", "IMDB is lower than", "Actor", "Director", "Title", "Released before year", "Released after year", "Type"],
  errorMessage: "Sorry, we didn't find any movies matching your search input.",
  movies: [
    {
